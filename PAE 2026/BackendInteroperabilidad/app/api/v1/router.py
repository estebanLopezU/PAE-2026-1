...
from .endpoints import auth, sectors, entities, services, maturity, dashboard, reports, ai_analysis, interoperability, relationships, agentgd
...
api_router.include_router(relationships.router, prefix="/relationships", tags=["Relaciones"])
